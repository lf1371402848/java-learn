										...
										<tbody id="tablelsw">
											<c:forEach items="${alltrainees}" var="trainee"
												...
												<tr>
													...
													<td><a href="trainee/showTraineeEdit/${trainee.id }"
														title="修改该学员信息" style="color: #2196f3">${trainee.traineeNo }</a>
													</td>
													<td>${trainee.name }</td>
													...
													<td><fmt:formatDate value="${trainee.enterDate }" pattern="yyyy-MM-dd" /></td>
													...
													<td>
                                                            ...
                                                            <c:if test="${fn:contains(trainee.status, 'exam4_pass')}">已通过科目四</c:if>

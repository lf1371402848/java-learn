$(document).ready(function () {      
	...
	var barLabel = eval('(' + schoolInOutNameBar + ')');
	var barData = eval('(' + schoolInOutValueBar + ')');	
	var chartData = {
			labels: barLabel,
			datasets: [{
				data: barData,          
	...
	var lineLabel = eval('(' + schoolInOutNameLine + ')');
	var lineInData = eval('(' + schoolInValueLine + ')');
	var lineOutData = eval('(' + schoolOutValueLine + ')');
	var chartData = {
			labels: lineLabel,
			datasets: [{
				data: lineInData,          
